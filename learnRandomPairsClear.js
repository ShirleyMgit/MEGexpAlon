...
function learnRandomPairsTask(fc){
   ...
   allrand[0].style.display="none";
	/* Print instructions*/
   inst.innerHTML="Try to remember the order in which the pictures are presented. It will help you during the next parts of the game.<br> Press enter to see the next card.";//<b>Is this picture tilt? </br>you get an extra point for any correct answer</br>";
   rMvPart[0].style.display="none";
